...
export default function Header() {
  ...
  return (
    <div className={styles.header}>
      ...
      <input type="text" onKeyUp={(e) => keyupSearchBooks(e)} placeholder="Rechercher" className={styles.rechercherLivre} />
...

      {
        <div className={styles.panierContainer} data-show={isPanierShow ? 1 : 0} >
          ...
          <Panier panierList={panierList}
            clickClosePanier={clickClosePanier}
          />
        </div>
      }
